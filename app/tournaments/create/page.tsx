...
export default function CreateTournament() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    if (!date) return setError("Tournament date is required.");
    ...
    const payload = {
      ...
      format,
      rounds: format === "RANDOM_ROUNDS" ? Number(rounds) : null,
      group_count: format === "GROUPS_KNOCKOUT" ? Number(groups) : null,
      qualifiers_per_group:
        format === "GROUPS_KNOCKOUT" ? Number(qualifiers) : null,
      ...
      <div className={s.shell}>
        <div className={s.top}>
          <div>
            ...
            <p className={s.sub}>
              Set the competition rules first. Players and partners come next.
            </p>
          </div>
        </div>
        ...
        <form className={s.card} onSubmit={submit}>
          <div className={s.grid2}>
            ...
            <div className={s.field}>
              ...
              >
                ...
                <option value="FIXED">Already fixed partners</option>
              </select>
            </div>
            ...
            <div className={s.field}>
              ...
              >
                <option value="KNOCKOUT">All knockout → final</option>
                <option value="ROUND_ROBIN">Round robin</option>
                <option value="GROUPS_KNOCKOUT">Groups → knockout</option>
                <option value="RANDOM_ROUNDS">Random matches by rounds</option>
              </select>
            </div>
          ...
          <div className={s.footerActions}>
            <a href="/tournaments" className={`${s.button} ${s.secondary}`}>
              Cancel
            </a>
            <button className={s.button} disabled={busy}>
              {busy ? "Creating…" : "Continue to players →"}
            </button>
          </div>
        </form>
      </div>
